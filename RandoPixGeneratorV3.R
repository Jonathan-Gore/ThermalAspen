...
folder.path <- "C:/Users/art.woods/Dropbox/uClim/UWyoming_bio_station_2018/IR_images/registeredIRimages_andGoodBadVals/"
...
for (imageNumber in fileNumbers){
  ...
  for (i in 1:20){
    ...
    #if(i %% 10 == 0) 
	plot(im.target.c)		# refresh image every 10 points
