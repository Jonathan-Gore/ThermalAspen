...
function [y] = multiObjectTracking(VideoFile)
...
%                 label = cellstr(int2str(tracks(i).id));
               ...
               frame = insertObjectAnnotation(frame, 'rectangle', ...
                    tracks(i).bbox, strcat('Predicted-',label));
                   p = cat(1,tracks(i).trails{:});
